...
<html>
    ...
    <body>
        ...
        <form action="<%= request.getContextPath() %>/chat" method="POST">
            ...
            <input type="text" id="message" name="message" size="50" placeholder="메시지를 입력하세요" required >
        ...
        <script>
            ...
            */
            ...
            const dateObject = new Date(reliableDateString); // 새로운 Date 객체 생성
